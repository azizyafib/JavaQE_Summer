...
public class Homework2_SuperMarketInvoice {
	...
	public static void main(String[] args) {
		...
		String storeAddress = "59 Goldsburg RD Bayonne,NJ,07002";
		...
		System.out
				.println("  " + itemName8 + "\t\t\t\t" + quantityNumber8 + "\t\t$" + price8 + "\t\t\t$" + total8 + "");
		System.out.println("  " + itemName9 + "\t\t" + quantityNumber9 + "\t\t$" + price9 + "\t\t\t$" + total9 + "");
		System.out.println();
		System.out.println("-------------------------------------------------------------------------------------");
		System.out.println("  Total Items Sold " + "            " + quantityTotal
				+ "                               SUBTOTAL:  $" + subtotal + "");
		System.out.println("                                                       SALE TAX (8.75%):" + " $" + tax);
